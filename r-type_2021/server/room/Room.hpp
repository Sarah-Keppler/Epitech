...
namespace RType::Server {
    ...
    class Room : public IRoom, public RType::ECS::IManager {
        public:
            ...
            void sendRequest(RType::Network::Request<T_Body> const &request, RType::Server::Network::EndPoint const &endpoint) noexcept;

            template<RType::Network::C_Body T_Body>
            void sendRequestToUsers(RType::Network::Request<T_Body> const &request) noexcept;
        private:
