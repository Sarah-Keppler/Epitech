...
//    _gameObjects.emplace_back(std::make_shared<RType::Client::GameObjects::Picture>(RType::ECS::ID(5), RType::ECS::SfmlDrawable(_window, "../../assets/pictures/infoFrame.png", std::make_pair(1920, 150), std::make_pair(1920, 150), std::make_pair(0, 0)), RType::ECS::Position(0, 0)));
//    _gameObjects.emplace_back(std::make_shared<RType::Client::GameObjects::Picture>(RType::ECS::ID(5), RType::ECS::SfmlDrawable(_window, "../../assets/pictures/infoFrame.png", std::make_pair(1920, 150), std::make_pair(1920, 150), std::make_pair(0, 0), std::make_pair(1, 1), 180), RType::ECS::Position(1920, 1080)));
...
//    _gameObjects.emplace_back(std::make_shared<RType::Client::GameObjects::Picture>(RType::ECS::ID(5), RType::ECS::SfmlDrawable(_window, "../../assets/pictures/heart.png", std::make_pair(200, 200), std::make_pair(200, 200), std::make_pair(0, 0), std::make_pair(0.2, 0.2)), RType::ECS::Position(700, 5)));
}
...
void RType::Client::Scene::GameScene::playerUpdate(RType::Network::RcvRequest &rcvRequest) noexcept {
    ...
    for (auto &gameObject: _gameObjects)
        if (dynamic_cast<RType::ECS::ID *>(gameObject.get())->getId() == request.id) {
            // TODO: add weapon
            if (!dynamic_cast<RType::Client::GameObjects::Player *>(gameObject.get())->isMe()) {
                auto pos = dynamic_cast<RType::ECS::Position *>(gameObject.get());
                pos->setXPos(request.position.first);
                pos->setYPos(request.position.second);
...
//            _gameObjects.emplace_back(std::make_shared<RType::Client::GameObjects::Enemy1>(RType::ECS::ID(request.id), RType::ECS::Position(request.position.first, request.position.second), RType::ECS::Acceleration(request.acceleration.first, request.acceleration.second), RType::ECS::SfmlDrawable(_window, "../../assets/sprites/ennemy1.png", std::make_pair(225, 285), std::make_pair(225, 285), std::make_pair(0, 0), std::make_pair(1, 1), 0)));
//            break;
//        case RType::Network::Udp::EnemyType::Enemy2:
//            _gameObjects.emplace_back(std::make_shared<RType::Client::GameObjects::Enemy2>(RType::ECS::ID(request.id), RType::ECS::Position(request.position.first, request.position.second), RType::ECS::Acceleration(request.acceleration.first, request.acceleration.second), RType::ECS::SfmlDrawable(_window, "../../assets/sprites/ennemy2.png", std::make_pair(283, 275), std::make_pair(283, 275), std::make_pair(0, 0), std::make_pair(1, 1), 0)));
//            break;
//        case RType::Network::Udp::EnemyType::Enemy3:
//            _gameObjects.emplace_back(std::make_shared<RType::Client::GameObjects::Enemy3>(RType::ECS::ID(request.id), RType::ECS::Position(request.position.first, request.position.second), RType::ECS::Acceleration(request.acceleration.first, request.acceleration.second), RType::ECS::SfmlDrawable(_window, "../../assets/sprites/ennemy3.png", std::make_pair(267, 237), std::make_pair(267, 237), std::make_pair(0, 0), std::make_pair(1, 1), 0)));
//            break;
...
void RType::Client::Scene::GameScene::sendPlayerUpdate(RType::Client::GameObjects::Player *player) noexcept {
    ...
    RType::Network::Udp::PlayerUpdate playerUpdate(std::make_pair(player->getXPos(), player->getYPos()),
                                                   ...
                                                   _client->getLobbyId()); //TODO: Check if it's ok with server (id things)
